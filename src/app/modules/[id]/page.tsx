  ...
  return (<main className="min-h-screen pt-16"><Navbar />
    <section className="py-24 px-6 hero-bg relative">
      ...
      <div className="relative z-10 max-w-[750px] mx-auto">
        <Link href="/#modules" className="inline-flex items-center gap-1.5 text-[14px] text-indigo-600 font-semibold mb-10"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg> Modules</Link>
        <div className="text-center">
          {mod.logo ? <div className="mb-6 flex justify-center"><Image src={mod.logo} alt={mod.name} width={144} height={144} className="w-28 h-28 rounded-2xl object-contain drop-shadow-lg" /></div> : <div className="text-6xl mb-6">{mod.icon}</div>}
