  ...
  return (
    <main>
      ...
      <section className="py-24 px-6 bg-indigo-soft">
        <ScrollReveal><div className="max-w-[750px] mx-auto text-center">
          ...
          <p className="text-slate-500 text-[17px] leading-relaxed">Academics, life skills, values, creativity, and leadership — all in one unified platform.</p>
        </div></ScrollReveal>
      </section>
      ...
      <section className="py-20 px-6 bg-dark relative overflow-hidden">
        ...
        <ScrollReveal><div className="max-w-[650px] mx-auto text-center relative z-10">
        ...
        <div className="flex animate-marquee whitespace-nowrap">
          {[...Array(2)].map((_,i) => (
            <div key={i} className="flex items-center gap-14 mx-7">
              {["LearnX","Santulan AI","GroerX","AJ's Learning","Vaani","Pratibimb","Nirmaan","Prajna","Shikha","Artha","Sangam","Guru"].map(n => (
